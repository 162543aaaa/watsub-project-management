import { BellIcon, CheckBadgeIcon, CheckCircleIcon, InformationCircleIcon, XCircleIcon } from '@heroicons/react/24/solid';
...
export default function Notifications() {
  ...
  const iconMap = { success: CheckCircleIcon, error: XCircleIcon, info: InformationCircleIcon };
  const colorMap = {
